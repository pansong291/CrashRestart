...
public abstract class Updata
{
 ...
 private String strUpdataMessage,
 ...
 private Handler handler=new Handler()
 {
  ...
  public void handleMessage(Message msg)
  {
   ...
   {
	thenDo(getAllUpData(msg.obj));
   }
  }
 };

 public Updata(Context c,String u)
 {
  contxt=c;
 ...
 private boolean getAllUpData(Object obj)
 {
  ...
  try
  {
   ...
   strUpdataMessage=josnObj.optString("NewMessage");
